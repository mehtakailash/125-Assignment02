...
//		Overrides Object.equals( Object ). Determines whether this ClientAccount is equal to a given object. 
//		The two objects are equal if they are both concrete ClientAccount objects, and all their corresponding properties are equal.
...
//		}
		...
		if (!address.equals(clientAccount.address)) return false;
        if (!contact.equals(clientAccount.contact)) return false;
        
        return name.equals(clientAccount.name);
	}
